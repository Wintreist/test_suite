...
# В PyInstaller spec файлах __file__ может быть не определен, используем os.getcwd()
spec_file_dir = Path(os.getcwd()) / 'build_scripts'
project_root = spec_file_dir.parent
